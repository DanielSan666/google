...
<header>
    ...
    <br>
            <br>
            <h1 class="edit1">Actualizar película</h1>

            <table>
            <form action="actualizar.php" method="post">
                <tr>
                    <td><label for="id">Folio: </label></td>
                    <td><input type="number" placeholder="Folio" name="id"></td>
                </tr>
                <tr>
                    <td><label for="nombre">Nombre: </label></td>
                    <td><input type="text" placeholder="Nombre del película" name="nombre"></td>
                </tr>
                <tr>
